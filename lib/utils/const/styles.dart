...
const logInScreenHeaderStyle = TextStyle(fontSize: 40, color: Colors.black38, fontWeight: FontWeight.bold);
const textStyle = TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.black);
